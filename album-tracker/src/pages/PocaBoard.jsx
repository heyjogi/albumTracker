...
const IMAGE_VERSION = '0425' // 이미지 캐시 버스팅을 위한 버전
...
// 보드 구조(앨범/카드 리스트) 캐시 유틸 (localStorage 사용 + 24시간 TTL)
const STRUCTURE_CACHE_KEY = `pocaboard_structure_v10_${IMAGE_VERSION}`
const CACHE_TTL = 7 * 24 * 60 * 60 * 1000 // 7일로 연장 (트래픽 최적화)
